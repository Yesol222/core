...
public class ApplicationContextExtendsFindTest {
    ...
    void findBeanByParentTypeBeanName(){
        ...
        assertThat(rateDiscountPolicy).isInstanceOf(RateDiscountPoicy.class);
    }

    @Test
    @DisplayName("특정 하위 타입으로 조회")
    void findBeanBySubType(){
        RateDiscountPoicy bean = ac.getBean(RateDiscountPoicy.class);
        assertThat(bean).isInstanceOf(RateDiscountPoicy.class);
    }
